...
▫️🌎 *𝗖ᴏᴜɴᴛʀʏ ➟ *_${movieData.metadata?.country || "𝙽/𝙰"}_*
▫️⏳ *𝗗ᴜʀᴀᴛɪᴏɴ ➟ *_${movieData.metadata?.runtime || "𝙽/𝙰"}_*

*➟➟➟➟➟➟➟➟➟➟➟➟➟➟➟*

*𝙹𝙾𝙸𝙽 𝚄𝚂 ➟* https://whatsapp.com/channel/0029VaFotDB1Hspphcudw834/971

*➟➟➟➟➟➟➟➟➟➟➟➟➟➟➟*

🪷 *ＰＩＮＫ ＬＯＴＵＳ ＣＩＮＥＭＡ* 🪷
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋᴀʟᴘʜᴀxᴛᴇᴍ ©️`.trim();
  },
...
▫️🌎 *𝗖ᴏᴜɴᴛʀʏ ➟ *_${metadata?.country || "𝙽/𝙰"}_*
▫️⏳ *𝗗ᴜʀᴀᴛɪᴏɴ ➟ *_${metadata?.runtime || "𝙽/𝙰"}_*
▫️🎭 *𝗚ᴇɴʀᴇꜱ ➟ *_${metadata?.genres.map((g) => `#${g}`).join(" • ") || "𝙽/𝙰"}_*
